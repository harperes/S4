...
class PySimulation
    ...
    void SetLayerPatternEllipse(std::string pyName, std::string pyMaterial, py::array_t<double> pyCenter, double pyAngle, py::array_t<double> pyWidths);
    ...
    py::array_t<double> GetPoyntingFluxByG(std::string pyLayer, double pyZOffset);
    ...
    py::array_t<double> GetWaves(std::string pyLayer);
